...
//   auto transform2 =
//       Acts::Transform3::Identity() * Acts::Translation3(Acts::Vector3(6, 0,
//       0));
...
//       std::make_shared<Acts::RectangleBounds>(2, 2));
//   auto surface2 = Acts::Surface::makeShared<Acts::PlaneSurface>(
//       transform1 * Acts::Translation3(0.1, 0, 0) *
//       Acts::Transform3(rotation), std::make_shared<Acts::RectangleBounds>(2,
//       2));
//   auto surface3 = Acts::Surface::makeShared<Acts::PlaneSurface>(
//       transform1 * Acts::Translation3(-0.1, 0, 0) *
//       Acts::Transform3(rotation), std::make_shared<Acts::RectangleBounds>(2,
...
//       transform1 * Acts::Translation3(0.0, 2.5, 0) *
//       Acts::Transform3(rotation),
//       std::make_shared<Acts::RectangleBounds>(0.1, 0.1));
...
//   }
//   // Surface ids: 12-14;
//   for (auto& surf : {surface1, surface2, surface3, decoySurface1,
//   decoySurface2,
//                      decoySurface3}) {
//     surf->assignGeometryId(id);
//     id++;
...
//   auto result =
//       propagator.makeResult(std::move(pState), pResult, options,
//       false).value();
//
//   auto states = result.get<StateRecorder::result_type>();
//
